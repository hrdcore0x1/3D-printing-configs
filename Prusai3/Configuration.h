...
#define STRING_CONFIG_H_AUTHOR "(Folger Tech Prusa i3 2020, default config - Cory Nance)" // Who made the changes.
...
#define HOMING_FEEDRATE {50*60, 50*60, 4*60, 0}  // set the homing speeds (mm/min)  May need to change to {50*60, 50*60, 50, 0}
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 62,0} // X,Y,Z Axis Extend and Retract angles
